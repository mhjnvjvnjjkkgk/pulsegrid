...
SYMPTOM_DATABASE = {
    ...
    "amar baba saas nite":              ("RED", "adult_icu", "Relative acute dyspnea (Benglish). Emergency oxygen & airway care."),
    "amar ma saas nite":                ("RED", "adult_icu", "Relative acute dyspnea (Benglish). Emergency oxygen & airway care."),
    ...
    "শ্বাস নিতে পারছে না":             ("RED", "adult_icu", "Severe dyspnea 3rd-person (Bangla). Emergency oxygen & airway support."),
